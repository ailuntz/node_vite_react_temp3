...
import './MyNewPage.css'; // 引入 CSS 文件

function MyNewPage() {

  useEffect(() => {
    // JavaScript 代码放在这里，确保在组件加载后执行
  ...
  return (
    <div>
      <div>
      <button className="my-new-page__button">不</button>
      </div>
